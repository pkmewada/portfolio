    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                ...
                <header id="hero" class="pg-hero">
                    <div class="container">
                        <div class="row mb-80px">
                            <div class="col-lg-12">
                                <div class="hero-title-wrap d-flex align-items-center justify-content-between">

                                    <h1 class="hero-title mb-0">
                                        <span class="hero-small">Helping Businesses</span>
                                        <span class="hero-big">STAY AHEAD !</span>
                                    </h1>

                                    <div class="hero-buttons d-flex gap-15px">
                                        <!-- Buttons -->
                                    </div>
                ...
                <section class="hero-style3 bg-img" data-background="assets/imgs/hero/4.jpg" data-overlay-dark="5"
                    style="background-image: url(&quot;assets/imgs/hero/4.jpg&quot;); translate: none; rotate: none; scale: none; transform: translate(0px, 0px);">
                    <div class="container"
                        ...
                        <div class="row align-items-end justify-content-between">
                            ...
                            <div class="col-lg-7 md-mb15">
                                ...
                                <div class="caption">
                                    <h1 class="fs-50 text-indent"> <br> We empower businesses to navigate what's next.
                                    </h1>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-8 offset-md-2 offset-1 col-10">
                                <p class="fs-16 mt-5px">Every project begins with understanding the business behind it.
                                    Marketing, technology, branding, automation, and creative execution are simply the
                                    tools we use to help businesses grow with clarity and confidence.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-3 col-md-4 sm-hide d-flex justify-content-end">
                                <div>
                                    <a href="page-pricing.html" class="butn-more d-flex align-items-center">
                                        <span class="text-uppercase fs-14 fw-500">See Pricing</span>
                        ...
                        <div class="row sm-marg">
                            ...
                            <div class="col-lg-9 md-mb10">
                                <div class="swiper-container" data-ui-animate data-delay="0.2"
                                    data-swiper='{"slidesPerView":1.5,"spaceBetween":30,"loop":true}'>
               ...
               <section id="portfolio" class="portfolio-style3">
    ...
    <header class="pg-hero">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="pt-15px">
                        <span class="butn-bord-sm mb-15px">Portfolio</span>
                    </div>
                </div>

                <div class="col-lg-10">
                    <h1 class="fs-80 text-uppercase">
                        <span class="opacity-7 d-inline">Reach our</span><br>
                        Featured Works
                    </h1>
                </div>
            </div>
    ...
    <div class="container">
        <div class="cardStacking">
            <div class="cardStacking__cards">
                ...
                <div class="stackCard mb-20px">
                    <div class="item fit-img h-600px border-radius-30px o-hidden position-relative">
                        <img src="assets/imgs/works/2/1.webp" alt="">
                        <div class="tags">
                            <span>Branding</span>
                        </div>
                        <div class="text w-100 text-align-center">
                            <h2><a href="project-details.html">Gary Neville's</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="stackCard mb-20px">
                    <div class="item fit-img h-600px border-radius-30px o-hidden position-relative">
                        <img src="assets/imgs/works/2/11.webp" alt="">
                        <div class="tags">
                            <span>UI-UX</span>
                        </div>
                        <div class="text w-100 text-align-center">
                            <h2><a href="project-details.html">Visual Narratives</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="stackCard mb-20px">
                    <div class="item fit-img h-600px border-radius-30px o-hidden position-relative">
                        <img src="assets/imgs/works/2/9.webp" alt="">
                        <div class="tags">
                            <span>Development</span>
                        </div>
                        <div class="text w-100 text-align-center">
                            <h2><a href="project-details.html">Consultancy Inspiring</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="stackCard mb-20px">
                    <div class="item fit-img h-600px border-radius-30px o-hidden position-relative">
                        <img src="assets/imgs/works/2/4.webp" alt="">
                        <div class="tags">
                            <span>Marketing</span>
                        </div>
                        <div class="text w-100 text-align-center">
                            <h2><a href="project-details.html">Furniture Designed</a></h2>
                        </div>
                    </div>
                </div>
